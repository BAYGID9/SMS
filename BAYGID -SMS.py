...
\033[1;99m╚════════════════════════════════════════════════════════════════════╝
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  ANONYMOUS BAYGID                 \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  BAYGID8                        \033[1;94m[+]
...
\033[1;94m[+]\033[1;32m               TOOL'S NAME  :  RANDOM CLONING                  \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟𝐔𝟕𝐏𝟒𝐋✮⃝  𝐈𝐍𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
...
print(""" \033[1;32m
     ...
     \033[38;5;46m  ____      __     _______ _____ _____   
    \033[38;5;46m |  _ \   /\\ \   / / ____|_   _|  __ \  
     \033[38;5;46m| |_) | /  \\ \_/ / |  __  | | | |  | | 
     \033[38;5;46m|  _ < / /\ \\   /| | |_ | | | | |  | | 
     \033[38;5;46m| |_) / ____ \| | | |__| |_| |_| |__| | 
     \033[38;5;46m|____/_/    \_\_|  \_____|_____|_____/                                                                              
